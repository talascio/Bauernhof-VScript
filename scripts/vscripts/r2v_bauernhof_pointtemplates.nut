::GiveWeapon <- function(player, classname, itemid, model)
{
	...
	trigger_hurt_brush2.SetSolid(2)
	...
	local math_counter7 = SpawnEntityFromTable("math_counter", {
	    ...
	    "outValue#2": "tf_gamerulesRunScriptCodeClientPrint(null, 4, ``)0-1"
	})
	...
	local logic_compare8 = SpawnEntityFromTable("logic_compare", {
	    ...
	    "OnEqualTo#2": "tf_gamerulesRunScriptCodeClientPrint(null, 4, `You've received a 1500 Survival Bonus!`)-1",
	...
	func_flagdetectionzone_brush3.SetSolid(2)
...
::Spawn_things <- function(org, ang)
{
	...
	func_forcefield_brush4.SetSolid(2)
	...
	trigger_teleport_brush5.SetSolid(2)
	...
	func_forcefield_brush6.SetSolid(2)
	...
	func_forcefield_brush7.SetSolid(2)
	...
	local logic_branch38 = SpawnEntityFromTable("logic_branch", {
	    ...
	    "OnFalse#4": "!activatorRunScriptCodeClientPrint(self, 4, `You've received an Überweapon: The Thunder Gun!`)0-1",
...
::Plate_Big <- function(org, ang)
{
	...
	func_rotating_brush8.SetSolid(2)
	...
	trigger_add_tf_player_condition_brush9.SetSolid(2)
	...
	trigger_add_tf_player_condition_brush10.SetSolid(2)
	...
	trigger_add_tf_player_condition_brush11.SetSolid(2)
	...
	trigger_add_tf_player_condition_brush12.SetSolid(2)
...
::BuildingBlocks <- function(org, ang)
{
	...
	func_nobuild_brush13.SetSolid(2)
	...
	func_nobuild_brush14.SetSolid(2)
	...
	func_nobuild_brush15.SetSolid(2)
	...
	func_nobuild_brush16.SetSolid(2)
	...
	func_nobuild_brush17.SetSolid(2)
	...
	func_nobuild_brush18.SetSolid(2)
	...
	func_nobuild_brush19.SetSolid(2)
	...
	func_nav_avoid_brush20.SetSolid(2)
	...
	local func_nav_avoid_brush21 = SpawnEntityFromTable("func_nav_avoid", {
	    ...
	    mins = "-140 -20 -132",
	    maxs = "140 20 132",
	    origin = Vector("-644, -492, -124")
	})
	func_nav_avoid_brush21.SetSolid(2)
	func_nav_avoid_brush21.KeyValueFromString("mins", "-140 -20 -132")
	func_nav_avoid_brush21.KeyValueFromString("maxs", "140 20 132")
	...
	func_nav_avoid_brush22.SetSolid(2)
	func_nav_avoid_brush22.KeyValueFromString("mins", "-140 -20 -132")
	func_nav_avoid_brush22.KeyValueFromString("maxs", "140 20 132")
	...
	func_nav_avoid_brush23.SetSolid(2)
	func_nav_avoid_brush23.KeyValueFromString("mins", "-84 -68 -48")
	func_nav_avoid_brush23.KeyValueFromString("maxs", "84 68 48")
	...
	func_nav_avoid_brush24.SetSolid(2)
	func_nav_avoid_brush24.KeyValueFromString("mins", "-384 -68 -48")
	func_nav_avoid_brush24.KeyValueFromString("maxs", "384 68 48")

	local func_nav_avoid_brush25 = SpawnEntityFromTable("func_nav_avoid", {
	    tags = "bigguyalert",
	    mins = "-116 -24 -72",
	    maxs = "166 24 72",
	    origin = Vector("-220, 1842, 144")
	})
	func_nav_avoid_brush25.SetSolid(2)
	func_nav_avoid_brush25.KeyValueFromString("mins", "-116 -24 -72")
	func_nav_avoid_brush25.KeyValueFromString("maxs", "166 24 72")

	local func_nav_avoid_brush26 = SpawnEntityFromTable("func_nav_avoid", {
	    tags = "bigguyalert",
	    mins = "-116 -32 -72",
	    maxs = "166 32 72",
	    origin = Vector("-220, 1192, 144")
	})
	func_nav_avoid_brush26.SetSolid(2)
	func_nav_avoid_brush26.KeyValueFromString("mins", "-116 -32 -72")
	func_nav_avoid_brush26.KeyValueFromString("maxs", "166 32 72")
	...
	func_forcefield_brush27.SetSolid(2)
	func_forcefield_brush27.KeyValueFromString("mins", "-64 -1472 -3168")
	func_forcefield_brush27.KeyValueFromString("maxs", "64 1472 3168")
	...
	func_forcefield_brush28.SetSolid(2)
	func_forcefield_brush28.KeyValueFromString("mins", "-4575 -4384 -32")
	func_forcefield_brush28.KeyValueFromString("maxs", "4575 4384 32")
	...
	func_forcefield_brush29.SetSolid(2)
	func_forcefield_brush29.KeyValueFromString("mins", "-194 -209 -514")
	func_forcefield_brush29.KeyValueFromString("maxs", "194 209 514")
	...
	func_forcefield_brush30.SetSolid(2)
	func_forcefield_brush30.KeyValueFromString("mins", "-96 -201.5 -480")
	func_forcefield_brush30.KeyValueFromString("maxs", "96 201.5 480")
	...
	func_forcefield_brush31.SetSolid(2)
	func_forcefield_brush31.KeyValueFromString("mins", "-192 -112 -560")
	func_forcefield_brush31.KeyValueFromString("maxs", "192 112 560")
	...
	func_forcefield_brush32.SetSolid(2)
	func_forcefield_brush32.KeyValueFromString("mins", "-736 -384 -8")
	func_forcefield_brush32.KeyValueFromString("maxs", "736 384 8")
	...
	func_forcefield_brush33.SetSolid(2)
	func_forcefield_brush33.KeyValueFromString("mins", "-12 -132 -72")
	func_forcefield_brush33.KeyValueFromString("maxs", "12 132 72")
	...
	func_forcefield_brush34.SetSolid(2)
	func_forcefield_brush34.KeyValueFromString("mins", "-80 -4 -72")
	func_forcefield_brush34.KeyValueFromString("maxs", "80 4 72")
	...
	func_forcefield_brush35.SetSolid(2)
	func_forcefield_brush35.KeyValueFromString("mins", "-48 -4 -48")
	func_forcefield_brush35.KeyValueFromString("maxs", "48 4 48")
	...
	func_forcefield_brush36.SetSolid(2)
	func_forcefield_brush36.KeyValueFromString("mins", "-4 -88 -48")
	func_forcefield_brush36.KeyValueFromString("maxs", "4 88 48")
	...
	func_forcefield_brush37.SetSolid(2)
	func_forcefield_brush37.KeyValueFromString("mins", "-20 -12 -48")
	func_forcefield_brush37.KeyValueFromString("maxs", "20 12 48")
	...
	func_forcefield_brush38.SetSolid(2)
	func_forcefield_brush38.KeyValueFromString("mins", "-40 -12 -58")
	func_forcefield_brush38.KeyValueFromString("maxs", "40 12 58")

	local func_forcefield_brush39 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-9 -192 -96",
	    maxs = "9 192 96",
	...
	func_forcefield_brush39.SetSolid(2)
	func_forcefield_brush39.KeyValueFromString("mins", "-9 -192 -96")
	func_forcefield_brush39.KeyValueFromString("maxs", "9 192 96")

	local func_forcefield_brush40 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-194 -608 -414",
	    maxs = "194 608 414",
	...
	func_forcefield_brush40.SetSolid(2)
	func_forcefield_brush40.KeyValueFromString("mins", "-194 -608 -414")
	func_forcefield_brush40.KeyValueFromString("maxs", "194 608 414")

	local func_forcefield_brush41 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-96 -143 -412",
	    maxs = "96 143 412",
	    origin = Vector("416, -1392, 900")
	})
	func_forcefield_brush41.SetSolid(2)
	func_forcefield_brush41.KeyValueFromString("mins", "-96 -143 -412")
	func_forcefield_brush41.KeyValueFromString("maxs", "96 143 412")

	local func_forcefield_brush42 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-84 -143 -12",
	    maxs = "84 143 12",
	    origin = Vector("428, -1392, 476")
	})
	func_forcefield_brush42.SetSolid(2)
	func_forcefield_brush42.KeyValueFromString("mins", "-84 -143 -12")
	func_forcefield_brush42.KeyValueFromString("maxs", "84 143 12")

	local func_forcefield_brush43 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-72 -143 -12",
	    maxs = "72 143 12",
	    origin = Vector("440, -1392, 452")
	})
	func_forcefield_brush43.SetSolid(2)
	func_forcefield_brush43.KeyValueFromString("mins", "-72 -143 -12")
	func_forcefield_brush43.KeyValueFromString("maxs", "72 143 12")

	local func_forcefield_brush44 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-64 -143 -12",
	    maxs = "64 143 12",
	    origin = Vector("448, -1392, 428")
	})
	func_forcefield_brush44.SetSolid(2)
	func_forcefield_brush44.KeyValueFromString("mins", "-64 -143 -12")
	func_forcefield_brush44.KeyValueFromString("maxs", "64 143 12")

	local func_forcefield_brush45 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-52 -143 -12",
	    maxs = "52 143 12",
	    origin = Vector("460, -1392, 404")
	})
	func_forcefield_brush45.SetSolid(2)
	func_forcefield_brush45.KeyValueFromString("mins", "-52 -143 -12")
	func_forcefield_brush45.KeyValueFromString("maxs", "52 143 12")

	local func_forcefield_brush46 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-44 -143 -12",
	    maxs = "44 143 12",
	    origin = Vector("468, -1392, 380")
	})
	func_forcefield_brush46.SetSolid(2)
	func_forcefield_brush46.KeyValueFromString("mins", "-44 -143 -12")
	func_forcefield_brush46.KeyValueFromString("maxs", "44 143 12")

	local func_forcefield_brush47 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-44 -143 -12",
	    maxs = "44 143 12",
	    origin = Vector("477, -1392, 356")
	})
	func_forcefield_brush47.SetSolid(2)
	func_forcefield_brush47.KeyValueFromString("mins", "-44 -143 -12")
	func_forcefield_brush47.KeyValueFromString("maxs", "44 143 12")

	local func_forcefield_brush48 = SpawnEntityFromTable("func_forcefield", {
	    StartDisabled = 0,
	    TeamNum = 3,
	    mins = "-44 -143 -12",
	    maxs = "44 143 12",
	    origin = Vector("486, -1392, 332")
	})
	func_forcefield_brush48.SetSolid(2)
	func_forcefield_brush48.KeyValueFromString("mins", "-44 -143 -12")
	func_forcefield_brush48.KeyValueFromString("maxs", "44 143 12")
...
::Pushblocks <- function(org, ang)
{
	...
	trigger_push_brush49.SetSolid(2)
	trigger_push_brush49.KeyValueFromString("mins", "-1 -192 -2")
	trigger_push_brush49.KeyValueFromString("maxs", "1 192 2")
	...
	trigger_push_brush50.SetSolid(2)
	trigger_push_brush50.KeyValueFromString("mins", "-32 -110 -11")
	trigger_push_brush50.KeyValueFromString("maxs", "32 110 11")
	...
	trigger_push_brush51.SetSolid(2)
	trigger_push_brush51.KeyValueFromString("mins", "-32 -72 -11")
	trigger_push_brush51.KeyValueFromString("maxs", "32 72 11")
	...
	trigger_push_brush52.SetSolid(2)
	trigger_push_brush52.KeyValueFromString("mins", "-32 -28 -11")
	trigger_push_brush52.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush53.SetSolid(2)
	trigger_push_brush53.KeyValueFromString("mins", "-32 -28 -11")
	trigger_push_brush53.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush54.SetSolid(2)
	trigger_push_brush54.KeyValueFromString("mins", "-32 -28 -11")
	trigger_push_brush54.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush55.SetSolid(2)
	trigger_push_brush55.KeyValueFromString("mins", "-32 -28 -11")
	trigger_push_brush55.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush56.SetSolid(2)
	trigger_push_brush56.KeyValueFromString("mins", "-32 -72 -11")
	trigger_push_brush56.KeyValueFromString("maxs", "32 72 11")
	...
	trigger_push_brush57.SetSolid(2)
	trigger_push_brush57.KeyValueFromString("mins", "32 -28 -11")
	trigger_push_brush57.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush58.SetSolid(2)
	trigger_push_brush58.KeyValueFromString("mins", "32 -28 -11")
	trigger_push_brush58.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush59.SetSolid(2)
	trigger_push_brush59.KeyValueFromString("mins", "32 -28 -11")
	trigger_push_brush59.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush60.SetSolid(2)
	trigger_push_brush60.KeyValueFromString("mins", "32 -28 -11")
	trigger_push_brush60.KeyValueFromString("maxs", "32 28 11")
	...
	trigger_push_brush61.SetSolid(2)
	trigger_push_brush61.KeyValueFromString("mins", "-10 -181 -12")
	trigger_push_brush61.KeyValueFromString("maxs", "10 181 12")
	...
	trigger_push_brush62.SetSolid(2)
	trigger_push_brush62.KeyValueFromString("mins", "-224 -12 -12")
	trigger_push_brush62.KeyValueFromString("maxs", "224 12 12")
	...
	trigger_push_brush63.SetSolid(2)
	trigger_push_brush63.KeyValueFromString("mins", "-208 -28 -20")
	trigger_push_brush63.KeyValueFromString("maxs", "208 28 20")
	...
	trigger_push_brush64.SetSolid(2)
	trigger_push_brush64.KeyValueFromString("mins", "-16 -196 -20")
	trigger_push_brush64.KeyValueFromString("maxs", "16 196 20")
	...
	trigger_push_brush65.SetSolid(2)
	trigger_push_brush65.KeyValueFromString("mins", "-12 -200 -28")
	trigger_push_brush65.KeyValueFromString("maxs", "12 200 28")
	...
	trigger_push_brush66.SetSolid(2)
	trigger_push_brush66.KeyValueFromString("mins", "-10 -483 -12")
	trigger_push_brush66.KeyValueFromString("maxs", "10 483 12")
	...
	trigger_push_brush67.SetSolid(2)
	trigger_push_brush67.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush67.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush68.SetSolid(2)
	trigger_push_brush68.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush68.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush69.SetSolid(2)
	trigger_push_brush69.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush69.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush70.SetSolid(2)
	trigger_push_brush70.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush70.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush71.SetSolid(2)
	trigger_push_brush71.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush71.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush72.SetSolid(2)
	trigger_push_brush72.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush72.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush73.SetSolid(2)
	trigger_push_brush73.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush73.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush74.SetSolid(2)
	trigger_push_brush74.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush74.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush75.SetSolid(2)
	trigger_push_brush75.KeyValueFromString("mins", "-48 -48 -12")
	trigger_push_brush75.KeyValueFromString("maxs", "48 48 12")
	...
	trigger_push_brush76.SetSolid(2)
	trigger_push_brush76.KeyValueFromString("mins", "-175 -175 -48")
	trigger_push_brush76.KeyValueFromString("maxs", "175 175 48")
	...
	trigger_push_brush77.SetSolid(2)
	trigger_push_brush77.KeyValueFromString("mins", "-158 -43 -84")
	trigger_push_brush77.KeyValueFromString("maxs", "158 43 84")

	local trigger_push_brush78 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 90 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush78.SetSolid(2)
	trigger_push_brush78.KeyValueFromString("mins", "-900 -3 -26")
	trigger_push_brush78.KeyValueFromString("maxs", "900 3 26")
	...
	trigger_push_brush79.SetSolid(2)
	trigger_push_brush79.KeyValueFromString("mins", "-136 -9.5 -12")
	trigger_push_brush79.KeyValueFromString("maxs", "136 9.5 12")

	local trigger_push_brush80 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 90 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush80.SetSolid(2)
	trigger_push_brush80.KeyValueFromString("mins", "-8 -60 12")
	trigger_push_brush80.KeyValueFromString("maxs", "8 60 12")

	local trigger_push_brush81 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 90 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush81.SetSolid(2)
	trigger_push_brush81.KeyValueFromString("mins", "-68 -48 12")
	trigger_push_brush81.KeyValueFromString("maxs", "68 48 12")

	local trigger_push_brush82 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 90 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush82.SetSolid(2)
	trigger_push_brush82.KeyValueFromString("mins", "-96 -16 -124")
	trigger_push_brush82.KeyValueFromString("maxs", "96 16 124")

	local trigger_push_brush83 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 270 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush83.SetSolid(2)
	trigger_push_brush83.KeyValueFromString("mins", "-56 -78 -24")
	trigger_push_brush83.KeyValueFromString("maxs", "56 78 24")

	local trigger_push_brush84 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 90 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush84.SetSolid(2)
	trigger_push_brush84.KeyValueFromString("mins", "-256 -4 -12")
	trigger_push_brush84.KeyValueFromString("maxs", "256 4 12")

	local trigger_push_brush85 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 270 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush85.SetSolid(2)
	trigger_push_brush85.KeyValueFromString("mins", "-68 -8 -4")
	trigger_push_brush85.KeyValueFromString("maxs", "68 8 4")

	local trigger_push_brush86 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 270 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush86.SetSolid(2)
	trigger_push_brush86.KeyValueFromString("mins", "-8 -32 -4")
	trigger_push_brush86.KeyValueFromString("maxs", "8 32 4")

	local trigger_push_brush87 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 270 0",
	    spawnflags = 1,
	    speed = 512,
	    StartDisabled = 0,
	...
	trigger_push_brush87.SetSolid(2)
	trigger_push_brush87.KeyValueFromString("mins", "-10.5 -608 -421.5")
	trigger_push_brush87.KeyValueFromString("maxs", "10.5 608 421.5")
...
::PlayersLeftLogic <- function(org, ang)
{
	local math_counter55 = SpawnEntityFromTable("math_counter", {
	    ...
	    startvalue = 0,
	    "outValue#1": "tf_gamerulesRunScriptCodeClientPrint(null, 4, ``)0-1",
...
::PlayerTracker <- function(org, ang)
{
	...
	local logic_relay65 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION3"
	})
...
{
	local trigger_multiple_brush88 = SpawnEntityFromTable("trigger_multiple", {
	...
	trigger_multiple_brush88.SetSolid(2)
	trigger_multiple_brush88.KeyValueFromString("mins", "-36 -36 -36")
	trigger_multiple_brush88.KeyValueFromString("maxs", "36 36 36")

	local logic_relay66 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "revive_trigger,DisableAndEndTouch,,0.0,-1",
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION4"
	})
...
::EnemyTracker <- function(org, ang)
{
	local logic_relay67 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION5"
	})
	...
	local logic_relay68 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION6"
	})
...
::Hulk_PT <- function(org, ang)
{
	...
	local logic_relay72 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION10"
	})
	...
	local logic_relay73 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnParentKilledOutput_CONVERSION11"
	})
...
{
	local trigger_push_brush89 = SpawnEntityFromTable("trigger_push", {
	    pushdir = "0 0 0",
	    spawnflags = 1,
	    speed = 1000,
	...
	trigger_push_brush89.SetSolid(2)
	trigger_push_brush89.KeyValueFromString("mins", "-24 -24 -24")
	trigger_push_brush89.KeyValueFromString("maxs", "24 24 24")
...
::Charger_PT <- function(org, ang)
{
	local logic_relay79 = SpawnEntityFromTable("logic_relay", {
	    ...
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION12"
	})
...
::Vending_Jugg <- function(org, ang)
{
	...
	func_button_brush90.SetSolid(2)
	...
	trigger_multiple_brush91.SetSolid(2)
...
::Vending_Speed <- function(org, ang)
{
	...
	local func_button_brush92 = SpawnEntityFromTable("func_button", {
	...
	func_button_brush92.SetSolid(2)
	func_button_brush92.KeyValueFromString("mins", "-24 -8 -44")
	func_button_brush92.KeyValueFromString("maxs", "24 8 44")
	...
	trigger_multiple_brush93.SetSolid(2)
	trigger_multiple_brush93.KeyValueFromString("mins", "-128 -128 0")
	trigger_multiple_brush93.KeyValueFromString("maxs", "64 64 128")
...
::Vending_Blaster <- function(org, ang)
{
	...
	local func_button_brush94 = SpawnEntityFromTable("func_button", {
	    origin = Vector("0, -12, 128"),
	...
	func_button_brush94.SetSolid(2)
	func_button_brush94.KeyValueFromString("mins", "-24 -8 -44")
	func_button_brush94.KeyValueFromString("maxs", "24 8 44")
	...
	trigger_multiple_brush95.SetSolid(2)
	trigger_multiple_brush95.KeyValueFromString("mins", "-128 -128 0")
	trigger_multiple_brush95.KeyValueFromString("maxs", "128 128 128")
...
::Vending_Doubletap <- function(org, ang)
{
	...
	local func_button_brush96 = SpawnEntityFromTable("func_button", {
	    origin = Vector("0, -12, 128"),
	...
	func_button_brush96.SetSolid(2)
	func_button_brush96.KeyValueFromString("mins", "-24 -8 -44")
	func_button_brush96.KeyValueFromString("maxs", "24 8 44")
	...
	trigger_multiple_brush97.SetSolid(2)
	trigger_multiple_brush97.KeyValueFromString("mins", "-128 -128 0")
	trigger_multiple_brush97.KeyValueFromString("maxs", "128 128 128")
	...
	local logic_relay149 = SpawnEntityFromTable("logic_relay", {
	    ...
	    "OnTrigger#4": "!activatorRunScriptCodeself.AddCustomAttribute(`mult_item_meter_charge_rate`, 0.67, -1)-1",
	    "OnTrigger#5": "!activatorRunScriptCodeself.AddCustomAttribute(`fire rate bonus`, 0.67, -1)-1",
	    "OnTrigger#6": "!activatorRunScriptCodeEmitSoundEx({sound_name = `weapons/buffed_on.wav`, channel = 0, volume = 1, pitch = 1, entity = self, filter_type = 4 })2.2-1",
	    "OnTrigger#7": "!activatorRunScriptCodeClientPrint(self, 4, `Perk Bonus activated: Increased fire rate!`)2.2-1",
	    "OnTrigger#8": "!activator,SpeakResponseConcept,TLK_PLAYER_SPELL_PICKUP_RARE,2.45,-1"
	})
...
::Vending_Quickrevive <- function(org, ang)
{
	...
	local func_button_brush98 = SpawnEntityFromTable("func_button", {
	    origin = Vector("0, -12, 128"),
	...
	func_button_brush98.SetSolid(2)
	func_button_brush98.KeyValueFromString("mins", "-24 -8 -44")
	func_button_brush98.KeyValueFromString("maxs", "24 8 44")
	...
	trigger_multiple_brush99.SetSolid(2)
	trigger_multiple_brush99.KeyValueFromString("mins", "-128 -128 0")
	trigger_multiple_brush99.KeyValueFromString("maxs", "128 128 128")
...
{
	local logic_relay157 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "roundcounter,SetValue,0,0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION15"
	})
	logic_relay157.SetOrigin(org)
	logic_relay157.SetAngles(ang[0], ang[1], ang[2])

	local game_text158 = SpawnEntityFromTable("game_text", {
	...
	game_text158.SetOrigin(org)
	game_text158.SetAngles(ang[0], ang[1], ang[2])

	local game_text159 = SpawnEntityFromTable("game_text", {
	...
	game_text159.SetOrigin(org)
	game_text159.SetAngles(ang[0], ang[1], ang[2])

	local game_text160 = SpawnEntityFromTable("game_text", {
	...
	game_text160.SetOrigin(org)
	game_text160.SetAngles(ang[0], ang[1], ang[2])

	local math_counter161 = SpawnEntityFromTable("math_counter", {
	    targetname = "roundcounter",
	    max = 255,
	    "outvalue#1": "roundformat,RunScriptCode,case01 ,0,-1",
	    "OutValue#2": "tf_objective_resourceRunScriptCodeNetProps.SetPropINVALID(self, `m_nMannVsMachineWaveCount`, )0-1",
	    "outvalue#3": "gameoverformat,RunScriptCode,case01 ,0,-1"
	})
	math_counter161.SetOrigin(org)
	math_counter161.SetAngles(ang[0], ang[1], ang[2])

	local math_counter162 = SpawnEntityFromTable("math_counter", {
	    targetname = "enemycounter",
	    startvalue = 0,
	    min = 0,
	    max = 26,
	    "outvalue#1": "enemyformat,RunScriptCode,case01 ,0,-1"
	})
	math_counter162.SetOrigin(org)
	math_counter162.SetAngles(ang[0], ang[1], ang[2])

	local logic_case163 = SpawnEntityFromTable("logic_case", {
	    targetname = "enemyformat",
	    case16 = "% active enemies",
	    "ondefault#1": "enemytext,RunScriptCode,message ,0,-1",
	    "ondefault#2": "enemytext,display,0,0,-1"
	})
	logic_case163.SetOrigin(org)
	logic_case163.SetAngles(ang[0], ang[1], ang[2])

	local logic_case164 = SpawnEntityFromTable("logic_case", {
	    targetname = "roundformat",
	    case16 = "Round %"
	})
	logic_case164.SetOrigin(org)
	logic_case164.SetAngles(ang[0], ang[1], ang[2])
	...
	local logic_relay166 = SpawnEntityFromTable("logic_relay", {
	...
	logic_relay166.SetOrigin(org)
	logic_relay166.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay167 = SpawnEntityFromTable("logic_relay", {
	...
	logic_relay167.SetOrigin(org)
	logic_relay167.SetAngles(ang[0], ang[1], ang[2])
...
{
	local env_entity_maker169 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "DoublePoints_spawner",
	    EntityTemplate = "DoublePointsDrop"
	})
	env_entity_maker169.SetOrigin(org)
	env_entity_maker169.SetAngles(ang[0], ang[1], ang[2])

}
::DoublePointsDrop <- function(org, ang)
{
	local info_particle_system170 = SpawnEntityFromTable("info_particle_system", {
	...
	info_particle_system170.SetOrigin(org)
	info_particle_system170.SetAngles(ang[0], ang[1], ang[2])
	...
	local func_rotating_brush100 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush100.SetSolid(2)
	func_rotating_brush100.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush100.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush101 = SpawnEntityFromTable("trigger_multiple", {
	...
	trigger_multiple_brush101.SetSolid(2)
	trigger_multiple_brush101.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush101.KeyValueFromString("maxs", "12 12 12")

	local logic_timer172 = SpawnEntityFromTable("logic_timer", {
	...
	logic_timer172.SetOrigin(org)
	logic_timer172.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer173 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 15,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,Enable,,-1"
	})
	logic_timer173.SetOrigin(org)
	logic_timer173.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer174 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer174.SetOrigin(org)
	logic_timer174.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer175 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer175.SetOrigin(org)
	logic_timer175.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer176 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer176.SetOrigin(org)
	logic_timer176.SetAngles(ang[0], ang[1], ang[2])

}
::FireSaleSpawner <- function(org, ang)
{
	local env_entity_maker177 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "FireSale_spawner",
	    EntityTemplate = "FireSaleDrop"
	})
	env_entity_maker177.SetOrigin(org)
	env_entity_maker177.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic178 = SpawnEntityFromTable("ambient_generic", {
	    health = 7,
	...
	ambient_generic178.SetOrigin(org)
	ambient_generic178.SetAngles(ang[0], ang[1], ang[2])
...
::FireSaleDrop <- function(org, ang)
{
	...
	local prop_dynamic180 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "powerup_prop",
	    parentname = "powerup_rot",
	...
	prop_dynamic180.SetOrigin(org)
	prop_dynamic180.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush102 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush102.SetSolid(2)
	func_rotating_brush102.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush102.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush103 = SpawnEntityFromTable("trigger_multiple", {
	    targetname = "powerup_trigger",
	    parentname = "powerup_prop",
	    filtername = "filter_redteam",
	    spawnflags = 1,
	...
	trigger_multiple_brush103.SetSolid(2)
	trigger_multiple_brush103.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush103.KeyValueFromString("maxs", "12 12 12")
	...
	local logic_timer182 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 15,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,Enable,,-1"
	})
	logic_timer182.SetOrigin(org)
	logic_timer182.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer183 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer183.SetOrigin(org)
	logic_timer183.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer184 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer184.SetOrigin(org)
	logic_timer184.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer185 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer185.SetOrigin(org)
	logic_timer185.SetAngles(ang[0], ang[1], ang[2])

}
::InstakillSpawner <- function(org, ang)
{
	local env_entity_maker186 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "Instakill_spawner",
	    EntityTemplate = "InstakillDrop"
	})
	env_entity_maker186.SetOrigin(org)
	env_entity_maker186.SetAngles(ang[0], ang[1], ang[2])
...
::InstakillDrop <- function(org, ang)
{
	...
	local prop_dynamic188 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "powerup_prop",
	    parentname = "powerup_rot",
	    model = "models/props_mvm/mvm_human_skull.mdl",
	    solid = 0,
	...
	prop_dynamic188.SetOrigin(org)
	prop_dynamic188.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush104 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush104.SetSolid(2)
	func_rotating_brush104.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush104.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush105 = SpawnEntityFromTable("trigger_multiple", {
	    targetname = "powerup_trigger",
	    parentname = "powerup_prop",
	    filtername = "filter_redteam",
	    spawnflags = 1,
	...
	trigger_multiple_brush105.SetSolid(2)
	trigger_multiple_brush105.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush105.KeyValueFromString("maxs", "12 12 12")
	...
	local logic_timer191 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer191.SetOrigin(org)
	logic_timer191.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer192 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer192.SetOrigin(org)
	logic_timer192.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer193 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer193.SetOrigin(org)
	logic_timer193.SetAngles(ang[0], ang[1], ang[2])

}
::NukeSpawner <- function(org, ang)
{
	local env_entity_maker194 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "Nuke_spawner",
	    EntityTemplate = "NukeDrop"
	})
	env_entity_maker194.SetOrigin(org)
	env_entity_maker194.SetAngles(ang[0], ang[1], ang[2])
...
::NukeDrop <- function(org, ang)
{
	...
	local prop_dynamic197 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "powerup_prop",
	    parentname = "powerup_rot",
	    model = "models/props_trainyard/cart_bomb_separate.mdl",
	    solid = 0,
	...
	prop_dynamic197.SetOrigin(org)
	prop_dynamic197.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush106 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush106.SetSolid(2)
	func_rotating_brush106.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush106.KeyValueFromString("maxs", "1 1 1")
	...
	trigger_multiple_brush107.SetSolid(2)
	trigger_multiple_brush107.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush107.KeyValueFromString("maxs", "12 12 12")
	...
	local logic_timer199 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 15,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,Enable,,-1"
	})
	logic_timer199.SetOrigin(org)
	logic_timer199.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer200 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer200.SetOrigin(org)
	logic_timer200.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer201 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer201.SetOrigin(org)
	logic_timer201.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer202 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer202.SetOrigin(org)
	logic_timer202.SetAngles(ang[0], ang[1], ang[2])

	local env_shake203 = SpawnEntityFromTable("env_shake", {
	    amplitude = 16,
	    duration = 3,
	    frequency = 40,
	    radius = 48,
	...
	env_shake203.SetOrigin(org)
	env_shake203.SetAngles(ang[0], ang[1], ang[2])

	local env_fade204 = SpawnEntityFromTable("env_fade", {
	    targetname = "nuke_fade",
	    duration = 1.3,
	    spawnflags = 1,
	    rendercolor = "255 255 255"
	})
	env_fade204.SetOrigin(org)
	env_fade204.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic205 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = ")misc/doomsday_missile_explosion.wav",
	    radius = 20,
	    pitch = 100,
	...
	ambient_generic205.SetOrigin(org)
	ambient_generic205.SetAngles(ang[0], ang[1], ang[2])

	local trigger_hurt_brush108 = SpawnEntityFromTable("trigger_hurt", {
	    damage = 4500,
	    spawnflags = 1,
	    mins = "-9999 -9999 -9999",
	    maxs = "9999 9999 9999",
	...
	trigger_hurt_brush108.SetSolid(2)
	trigger_hurt_brush108.KeyValueFromString("mins", "-9999 -9999 -9999")
	trigger_hurt_brush108.KeyValueFromString("maxs", "9999 9999 9999")

	local filter_activator_tfteam206 = SpawnEntityFromTable("filter_activator_tfteam", {
	    targetname = "filter_notred",
	    teamnum = 2,
	    negated = 1
	})
	filter_activator_tfteam206.SetOrigin(org)
	filter_activator_tfteam206.SetAngles(ang[0], ang[1], ang[2])

}
::MaxAmmoSpawner <- function(org, ang)
{
	local env_entity_maker207 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "MaxAmmo_spawner",
	    EntityTemplate = "MaxAmmoDrop"
	})
	env_entity_maker207.SetOrigin(org)
	env_entity_maker207.SetAngles(ang[0], ang[1], ang[2])

}
::MaxAmmoDrop <- function(org, ang)
{
	local info_particle_system208 = SpawnEntityFromTable("info_particle_system", {
	    effect_name = "spellbook_rainbow",
	    targetname = "powerup_particle",
	    parentname = "powerup_prop",
	    start_active = 1,
	...
	info_particle_system208.SetOrigin(org)
	info_particle_system208.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic209 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "powerup_prop",
	    parentname = "powerup_rot",
	...
	prop_dynamic209.SetOrigin(org)
	prop_dynamic209.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush109 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush109.SetSolid(2)
	func_rotating_brush109.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush109.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush110 = SpawnEntityFromTable("trigger_multiple", {
	    targetname = "powerup_trigger",
	    parentname = "powerup_prop",
	    filtername = "filter_redteam",
	    spawnflags = 1,
	...
	trigger_multiple_brush110.SetSolid(2)
	trigger_multiple_brush110.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush110.KeyValueFromString("maxs", "12 12 12")

	local logic_timer210 = SpawnEntityFromTable("logic_timer", {
	    targetname = "powerup_blinker",
	    RefireTime = 0.5,
	    spawnflags = 1,
	    parentname = "powerup_prop",
	...
	logic_timer210.SetOrigin(org)
	logic_timer210.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer211 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 15,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,Enable,,-1"
	})
	logic_timer211.SetOrigin(org)
	logic_timer211.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer212 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer212.SetOrigin(org)
	logic_timer212.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer213 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer213.SetOrigin(org)
	logic_timer213.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer214 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer214.SetOrigin(org)
	logic_timer214.SetAngles(ang[0], ang[1], ang[2])

}
::BonusPointsSpawner <- function(org, ang)
{
	local env_entity_maker215 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "BonusPoints_spawner",
	    EntityTemplate = "BonusPointsDrop"
	})
	env_entity_maker215.SetOrigin(org)
	env_entity_maker215.SetAngles(ang[0], ang[1], ang[2])

}
::BonusPointsDrop <- function(org, ang)
{
	local info_particle_system216 = SpawnEntityFromTable("info_particle_system", {
	    effect_name = "spellbook_rainbow",
	    targetname = "powerup_particle",
	    parentname = "powerup_prop",
	    start_active = 1,
	...
	info_particle_system216.SetOrigin(org)
	info_particle_system216.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic217 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "powerup_prop",
	    parentname = "powerup_rot",
	    model = "models/items/currencypack_large.mdl",
	    solid = 0,
	...
	prop_dynamic217.SetOrigin(org)
	prop_dynamic217.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush111 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 65,
	    maxspeed = 48,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush111.SetSolid(2)
	func_rotating_brush111.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush111.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush112 = SpawnEntityFromTable("trigger_multiple", {
	    targetname = "powerup_trigger",
	    parentname = "powerup_prop",
	    filtername = "filter_redteam",
	    spawnflags = 1,
	...
	trigger_multiple_brush112.SetSolid(2)
	trigger_multiple_brush112.KeyValueFromString("mins", "-12 -12 -12")
	trigger_multiple_brush112.KeyValueFromString("maxs", "12 12 12")
	...
	local logic_timer220 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 20,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.25,-1"
	})
	logic_timer220.SetOrigin(org)
	logic_timer220.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer221 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 25,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_blinker,RefireTime,0.1,-1"
	})
	logic_timer221.SetOrigin(org)
	logic_timer221.SetAngles(ang[0], ang[1], ang[2])

	local logic_timer222 = SpawnEntityFromTable("logic_timer", {
	    RefireTime = 30,
	    parentname = "powerup_prop",
	    "OnTimer#1": "powerup_rot,KillHierarchy,,-1"
	})
	logic_timer222.SetOrigin(org)
	logic_timer222.SetAngles(ang[0], ang[1], ang[2])

}
::DumpsterSpawner <- function(org, ang)
{
	local env_entity_maker223 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "dumpster_spawner1",
	    EntityTemplate = "DumpsterBoxRewrite1"
	})
	env_entity_maker223.SetOrigin(org)
	env_entity_maker223.SetAngles(ang[0], ang[1], ang[2])

	local env_entity_maker224 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "dumpster_spawner2",
	    EntityTemplate = "DumpsterBoxRewrite2",
	    angles = QAngle("0, 270, 0")
	})
	env_entity_maker224.SetOrigin(org)
	env_entity_maker224.SetAngles(ang[0], ang[1], ang[2])

	local env_entity_maker225 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "dumpster_spawner3",
	    EntityTemplate = "DumpsterBoxRewrite3"
	})
	env_entity_maker225.SetOrigin(org)
	env_entity_maker225.SetAngles(ang[0], ang[1], ang[2])

	local env_entity_maker226 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "dumpster_spawner4",
	    EntityTemplate = "DumpsterBoxRewrite4",
	    angles = QAngle("0, 180, 0")
	})
	env_entity_maker226.SetOrigin(org)
	env_entity_maker226.SetAngles(ang[0], ang[1], ang[2])

	local env_entity_maker227 = SpawnEntityFromTable("env_entity_maker", {
	    targetname = "dumpster_spawner5",
	    EntityTemplate = "DumpsterBoxRewrite5"
	})
	env_entity_maker227.SetOrigin(org)
	env_entity_maker227.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport228 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_1",
	    origin = Vector("447, -2322, 8"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport228.SetOrigin(org)
	point_teleport228.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport229 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_2",
	    origin = Vector("-399, -1380, -1"),
	    angles = QAngle("0, 270, 0")
	})
	point_teleport229.SetOrigin(org)
	point_teleport229.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport230 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_3",
	    origin = Vector("986, 1338, 96"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport230.SetOrigin(org)
	point_teleport230.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport231 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_4",
	    origin = Vector("-788, 1016, -1"),
	    angles = QAngle("0, 180, 0")
	})
	point_teleport231.SetOrigin(org)
	point_teleport231.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport232 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_5",
	    origin = Vector("-548, -2216, 3"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport232.SetOrigin(org)
	point_teleport232.SetAngles(ang[0], ang[1], ang[2])
...
{
	local prop_dynamic234 = SpawnEntityFromTable("prop_dynamic", {
	...
	prop_dynamic234.SetOrigin(org)
	prop_dynamic234.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system235 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "eyeboss_tp_vortex",
	    targetname = "dumpster_warp_eff1",
	    parentname = "dumpster_prop1"
	})
	info_particle_system235.SetOrigin(org)
	info_particle_system235.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system236 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "teleporter_mvm_bot_persist",
	    targetname = "dumpster_warp_beam1",
	    parentname = "dumpster_prop1"
	})
	info_particle_system236.SetOrigin(org)
	info_particle_system236.SetAngles(ang[0], ang[1], ang[2])
	...
	prop_dynamic237.SetOrigin(org)
	prop_dynamic237.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic238 = SpawnEntityFromTable("prop_dynamic", {
	...
	prop_dynamic238.SetOrigin(org)
	prop_dynamic238.SetAngles(ang[0], ang[1], ang[2])
	...
	func_door_rotating_brush114.SetSolid(2)
	...
	light_dynamic239.SetOrigin(org)
	light_dynamic239.SetAngles(ang[0], ang[1], ang[2])
	...
	local prop_dynamic241 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "dumpster_weapon1",
	    parentname = "dumpster_train1",
	    model = "models/weapons/w_models/w_medigun.mdl",
	    solid = 0
	})
	prop_dynamic241.SetOrigin(org)
	prop_dynamic241.SetAngles(ang[0], ang[1], ang[2])
	...
	ambient_generic242.SetOrigin(org)
	ambient_generic242.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic243 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	...
	ambient_generic243.SetOrigin(org)
	ambient_generic243.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic244 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	...
	ambient_generic244.SetOrigin(org)
	ambient_generic244.SetAngles(ang[0], ang[1], ang[2])

}
::DumpsterBoxRewrite2 <- function(org, ang)
{
	local prop_dynamic245 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 104"),
	    angles = QAngle("90, 0, 180"),
	    disableshadows = 0,
	    model = "models/workshop/player/items/all_class/mvm_memes_player/mvm_memes_player_heavy.mdl",
	...
	prop_dynamic245.SetOrigin(org)
	prop_dynamic245.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system246 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "eyeboss_tp_vortex",
	    targetname = "dumpster_warp_eff2",
	    parentname = "dumpster_prop2"
	})
	info_particle_system246.SetOrigin(org)
	info_particle_system246.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system247 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "teleporter_mvm_bot_persist",
	    targetname = "dumpster_warp_beam2",
	    parentname = "dumpster_prop2"
	})
	info_particle_system247.SetOrigin(org)
	info_particle_system247.SetAngles(ang[0], ang[1], ang[2])
	...
	prop_dynamic248.SetOrigin(org)
	prop_dynamic248.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic249 = SpawnEntityFromTable("prop_dynamic", {
	...
	prop_dynamic249.SetOrigin(org)
	prop_dynamic249.SetAngles(ang[0], ang[1], ang[2])
	...
	func_door_rotating_brush118.SetSolid(2)
	...
	light_dynamic250.SetOrigin(org)
	light_dynamic250.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system251 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 0"),
	    effect_name = "utaunt_beams_yellow",
	    targetname = "dumpster_particles2",
	    parentname = "dumpster_prop2"
	})
	info_particle_system251.SetOrigin(org)
	info_particle_system251.SetAngles(ang[0], ang[1], ang[2])
	...
	ambient_generic253.SetOrigin(org)
	ambient_generic253.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic254 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "misc/halloween/merasmus_appear.wav",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic254.SetOrigin(org)
	ambient_generic254.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic255 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "misc/halloween/merasmus_disappear.wav",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic255.SetOrigin(org)
	ambient_generic255.SetAngles(ang[0], ang[1], ang[2])
...
::DumpsterBoxRewrite3 <- function(org, ang)
{
	...
	local info_particle_system257 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "eyeboss_tp_vortex",
	    targetname = "dumpster_warp_eff3",
	    parentname = "dumpster_prop3"
	})
	info_particle_system257.SetOrigin(org)
	info_particle_system257.SetAngles(ang[0], ang[1], ang[2])
	...
	trigger_push_brush121.SetSolid(2)
	...
	local prop_dynamic260 = SpawnEntityFromTable("prop_dynamic", {
	...
	prop_dynamic260.SetOrigin(org)
	prop_dynamic260.SetAngles(ang[0], ang[1], ang[2])
	...
	func_door_rotating_brush122.SetSolid(2)
	...
	light_dynamic261.SetOrigin(org)
	light_dynamic261.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system262 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 0"),
	    effect_name = "utaunt_beams_yellow",
	    targetname = "dumpster_particles3",
	    parentname = "dumpster_prop3"
	})
	info_particle_system262.SetOrigin(org)
	info_particle_system262.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic263 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "dumpster_weapon3",
	    parentname = "dumpster_train3",
	    model = "models/weapons/w_models/w_medigun.mdl",
	    solid = 0
	})
	prop_dynamic263.SetOrigin(org)
	prop_dynamic263.SetAngles(ang[0], ang[1], ang[2])
	...
	func_tracktrain_brush124.SetSolid(2)
	...
	local ambient_generic265 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "misc/halloween/merasmus_appear.wav",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic265.SetOrigin(org)
	ambient_generic265.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic266 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "misc/halloween/merasmus_disappear.wav",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic266.SetOrigin(org)
	ambient_generic266.SetAngles(ang[0], ang[1], ang[2])

}
::DumpsterBoxRewrite4 <- function(org, ang)
{
	local prop_dynamic267 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 104"),
	    angles = QAngle("90, 0, 180"),
	    disableshadows = 0,
	    model = "models/workshop/player/items/all_class/mvm_memes_player/mvm_memes_player_heavy.mdl",
	...
	prop_dynamic267.SetOrigin(org)
	prop_dynamic267.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system268 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "eyeboss_tp_vortex",
	    targetname = "dumpster_warp_eff4",
	    parentname = "dumpster_prop4"
	})
	info_particle_system268.SetOrigin(org)
	info_particle_system268.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system269 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "teleporter_mvm_bot_persist",
	    targetname = "dumpster_warp_beam4",
	    parentname = "dumpster_prop4"
	})
	info_particle_system269.SetOrigin(org)
	info_particle_system269.SetAngles(ang[0], ang[1], ang[2])

	local trigger_push_brush125 = SpawnEntityFromTable("trigger_push", {
	    origin = Vector("0, 0, 0"),
	    pushdir = "0 180 0",
	    spawnflags = 1,
	    speed = 512,
	...
	trigger_push_brush125.SetSolid(2)
	trigger_push_brush125.KeyValueFromString("mins", "-32 -66 -16")
	trigger_push_brush125.KeyValueFromString("maxs", "12 66 64")

	local prop_dynamic270 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 0"),
	    disableshadows = 0,
	    model = "models/props_construction/dumpster_body.mdl",
	    solid = 6,
	...
	prop_dynamic270.SetOrigin(org)
	prop_dynamic270.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic271 = SpawnEntityFromTable("prop_dynamic", {
	...
	prop_dynamic271.SetOrigin(org)
	prop_dynamic271.SetAngles(ang[0], ang[1], ang[2])

	local func_door_rotating_brush126 = SpawnEntityFromTable("func_door_rotating", {
	...
	func_door_rotating_brush126.SetSolid(2)
	func_door_rotating_brush126.KeyValueFromString("mins", "-2 -2 -2")
	func_door_rotating_brush126.KeyValueFromString("maxs", "2 2 2")

	local trigger_multiple_brush127 = SpawnEntityFromTable("trigger_multiple", {
	    origin = Vector("0, 0, 50"),
	...
	trigger_multiple_brush127.SetSolid(2)
	trigger_multiple_brush127.KeyValueFromString("mins", "-72 -74 -64")
	trigger_multiple_brush127.KeyValueFromString("maxs", "40 74 96")

	local light_dynamic272 = SpawnEntityFromTable("light_dynamic", {
	    origin = Vector("0, 0, 20"),
	...
	light_dynamic272.SetOrigin(org)
	light_dynamic272.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system273 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 0"),
	    effect_name = "utaunt_beams_yellow",
	    targetname = "dumpster_particles4",
	    parentname = "dumpster_prop4"
	})
	info_particle_system273.SetOrigin(org)
	info_particle_system273.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic274 = SpawnEntityFromTable("prop_dynamic", {
	    targetname = "dumpster_weapon4",
	    parentname = "dumpster_train4",
	    model = "models/weapons/w_models/w_medigun.mdl",
	    solid = 0
	})
	prop_dynamic274.SetOrigin(org)
	prop_dynamic274.SetAngles(ang[0], ang[1], ang[2])

	local func_tracktrain_brush128 = SpawnEntityFromTable("func_tracktrain", {
	...
	func_tracktrain_brush128.SetSolid(2)
	func_tracktrain_brush128.KeyValueFromString("mins", "-4 -4 -4")
	func_tracktrain_brush128.KeyValueFromString("maxs", "4 4 4")
...
::DumpsterBoxRewrite5 <- function(org, ang)
{
	...
	local trigger_push_brush129 = SpawnEntityFromTable("trigger_push", {
	    origin = Vector("0, 0, 0"),
	    pushdir = "0 180 0",
	    spawnflags = 1,
	    speed = 512,
	...
	trigger_push_brush129.SetSolid(2)
	trigger_push_brush129.KeyValueFromString("mins", "-32 -66 -16")
	trigger_push_brush129.KeyValueFromString("maxs", "12 66 64")
	...
	local func_door_rotating_brush130 = SpawnEntityFromTable("func_door_rotating", {
	...
	func_door_rotating_brush130.SetSolid(2)
	func_door_rotating_brush130.KeyValueFromString("mins", "-2 -2 -2")
	func_door_rotating_brush130.KeyValueFromString("maxs", "2 2 2")

	local trigger_multiple_brush131 = SpawnEntityFromTable("trigger_multiple", {
	    origin = Vector("0, 0, 50"),
	...
	trigger_multiple_brush131.SetSolid(2)
	trigger_multiple_brush131.KeyValueFromString("mins", "-72 -74 -64")
	trigger_multiple_brush131.KeyValueFromString("maxs", "40 74 96")
	...
	local func_tracktrain_brush132 = SpawnEntityFromTable("func_tracktrain", {
	...
	func_tracktrain_brush132.SetSolid(2)
	func_tracktrain_brush132.KeyValueFromString("mins", "-4 -4 -4")
	func_tracktrain_brush132.KeyValueFromString("maxs", "4 4 4")

	local ambient_generic286 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "shadows/mystery_jingle.mp3",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic286.SetOrigin(org)
	ambient_generic286.SetAngles(ang[0], ang[1], ang[2])

	local ambient_generic287 = SpawnEntityFromTable("ambient_generic", {
	    health = 10,
	    message = "misc/halloween/merasmus_appear.wav",
	    radius = 11000,
	    spawnflags = 48,
	...
	ambient_generic287.SetOrigin(org)
	ambient_generic287.SetAngles(ang[0], ang[1], ang[2])
...
{
	local logic_relay289 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "dumpster_warp_roulette,PickRandomShuffle,,0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION16"
	})
	logic_relay289.SetOrigin(org)
	logic_relay289.SetAngles(ang[0], ang[1], ang[2])

	local $filter_sendprop290 = SpawnEntityFromTable("$filter_sendprop", {
	...
	$filter_sendprop290.SetOrigin(org)
	$filter_sendprop290.SetAngles(ang[0], ang[1], ang[2])

	local filter_multi291 = SpawnEntityFromTable("filter_multi", {
	...
	filter_multi291.SetOrigin(org)
	filter_multi291.SetAngles(ang[0], ang[1], ang[2])

	local filter_damage_type292 = SpawnEntityFromTable("filter_damage_type", {
	    targetname = "filter_melee",
	    negated = 0,
	    damagetype = 134221952
	})
	filter_damage_type292.SetOrigin(org)
	filter_damage_type292.SetAngles(ang[0], ang[1], ang[2])
	...
	local info_particle_system294 = SpawnEntityFromTable("info_particle_system", {
	    origin = Vector("0, 0, 24"),
	    effect_name = "teleporter_mvm_bot_persist",
	    targetname = "dumpster_warp_beam",
	    parentname = "dumpster_prop"
	})
	info_particle_system294.SetOrigin(org)
	info_particle_system294.SetAngles(ang[0], ang[1], ang[2])

	local trigger_multiple_brush133 = SpawnEntityFromTable("trigger_multiple", {
	    origin = Vector("0, 0, 50"),
	...
	trigger_multiple_brush133.SetSolid(2)
	trigger_multiple_brush133.KeyValueFromString("mins", "-64 -64 -64")
	trigger_multiple_brush133.KeyValueFromString("maxs", "96 96 96")

	local trigger_push_brush134 = SpawnEntityFromTable("trigger_push", {
	    origin = Vector("0, 0, 0"),
	    pushdir = "0 0 0",
	    spawnflags = 1,
	    speed = 512,
	...
	trigger_push_brush134.SetSolid(2)
	trigger_push_brush134.KeyValueFromString("mins", "-12 -64 -16")
	trigger_push_brush134.KeyValueFromString("maxs", "12 64 16")

	local logic_relay295 = SpawnEntityFromTable("logic_relay", {
	...
	logic_relay295.SetOrigin(org)
	logic_relay295.SetAngles(ang[0], ang[1], ang[2])

	local logic_case296 = SpawnEntityFromTable("logic_case", {
	...
	logic_case296.SetOrigin(org)
	logic_case296.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport297 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_out",
	    target = "dumpster_prop",
	    origin = Vector("-512, -25, -1008"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport297.SetOrigin(org)
	point_teleport297.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport298 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_1",
	    target = "dumpster_prop",
	    origin = Vector("447, -2322, 8"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport298.SetOrigin(org)
	point_teleport298.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport299 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_2",
	    target = "dumpster_prop",
	    origin = Vector("-399, -1380, -1"),
	    angles = QAngle("0, 270, 0")
	})
	point_teleport299.SetOrigin(org)
	point_teleport299.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport300 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_3",
	    target = "dumpster_prop",
	    origin = Vector("986, 1338, 96"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport300.SetOrigin(org)
	point_teleport300.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport301 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_4",
	    target = "dumpster_prop",
	    origin = Vector("-788, 1016, -1"),
	    angles = QAngle("0, 180, 0")
	})
	point_teleport301.SetOrigin(org)
	point_teleport301.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport302 = SpawnEntityFromTable("point_teleport", {
	    targetname = "dumpster_tele_5",
	    target = "dumpster_prop",
	    origin = Vector("-548, -2216, 3"),
	    angles = QAngle("0, 0, 0")
	})
	point_teleport302.SetOrigin(org)
	point_teleport302.SetAngles(ang[0], ang[1], ang[2])

	local logic_case303 = SpawnEntityFromTable("logic_case", {
	...
	logic_case303.SetOrigin(org)
	logic_case303.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic304 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 104"),
	    angles = QAngle("90, 0, 180"),
	    disableshadows = 0,
	    model = "models/workshop/player/items/all_class/mvm_memes_player/mvm_memes_player_heavy.mdl",
	...
	prop_dynamic304.SetOrigin(org)
	prop_dynamic304.SetAngles(ang[0], ang[1], ang[2])

	local training_annotation305 = SpawnEntityFromTable("training_annotation", {
	    targetname = "dumpster_hint",
	    display_text = "Follow the beam of light to find the Weapons Dumpster!",
	    lifetime = 5,
	    origin = Vector(0, 0, 256)
	})
	training_annotation305.SetOrigin(org)
	training_annotation305.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic306 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 0"),
	    disableshadows = 0,
	    model = "models/props_construction/dumpster_body.mdl",
	    solid = 6,
	...
	prop_dynamic306.SetOrigin(org)
	prop_dynamic306.SetAngles(ang[0], ang[1], ang[2])

	local light_dynamic307 = SpawnEntityFromTable("light_dynamic", {
	...
	light_dynamic307.SetOrigin(org)
	light_dynamic307.SetAngles(ang[0], ang[1], ang[2])

	local prop_dynamic308 = SpawnEntityFromTable("prop_dynamic", {
	    origin = Vector("0, 0, 0"),
	    disableshadows = 0,
	    model = "models/props_construction/dumpster_lid.mdl",
	    solid = 0,
	...
	prop_dynamic308.SetOrigin(org)
	prop_dynamic308.SetAngles(ang[0], ang[1], ang[2])

	local func_door_rotating_brush135 = SpawnEntityFromTable("func_door_rotating", {
	...
	func_door_rotating_brush135.SetSolid(2)
	func_door_rotating_brush135.KeyValueFromString("mins", "-2 -2 -2")
	func_door_rotating_brush135.KeyValueFromString("maxs", "2 2 2")

	local func_button_brush136 = SpawnEntityFromTable("func_button", {
	...
	func_button_brush136.SetSolid(2)
	func_button_brush136.KeyValueFromString("mins", "-4 -44 -20")
	func_button_brush136.KeyValueFromString("maxs", "4 44 20")

	local logic_case309 = SpawnEntityFromTable("logic_case", {
	...
	logic_case309.SetOrigin(org)
	logic_case309.SetAngles(ang[0], ang[1], ang[2])

	local logic_case310 = SpawnEntityFromTable("logic_case", {
	...
	logic_case310.SetOrigin(org)
	logic_case310.SetAngles(ang[0], ang[1], ang[2])
	...
	local logic_case312 = SpawnEntityFromTable("logic_case", {
	...
	logic_case312.SetOrigin(org)
	logic_case312.SetAngles(ang[0], ang[1], ang[2])

	local logic_case313 = SpawnEntityFromTable("logic_case", {
	...
	logic_case313.SetOrigin(org)
	logic_case313.SetAngles(ang[0], ang[1], ang[2])

	local logic_case314 = SpawnEntityFromTable("logic_case", {
	...
	logic_case314.SetOrigin(org)
	logic_case314.SetAngles(ang[0], ang[1], ang[2])

	local logic_case315 = SpawnEntityFromTable("logic_case", {
	...
	logic_case315.SetOrigin(org)
	logic_case315.SetAngles(ang[0], ang[1], ang[2])

	local logic_case316 = SpawnEntityFromTable("logic_case", {
	...
	logic_case316.SetOrigin(org)
	logic_case316.SetAngles(ang[0], ang[1], ang[2])

	local logic_case317 = SpawnEntityFromTable("logic_case", {
	...
	logic_case317.SetOrigin(org)
	logic_case317.SetAngles(ang[0], ang[1], ang[2])

}
::TankTeleport <- function(org, ang)
{
	local trigger_teleport_brush137 = SpawnEntityFromTable("trigger_teleport", {
	...
	trigger_teleport_brush137.SetSolid(2)
	trigger_teleport_brush137.KeyValueFromString("mins", "-1 -1 -1")
	trigger_teleport_brush137.KeyValueFromString("maxs", "1 1 1")

	local trigger_multiple_brush138 = SpawnEntityFromTable("trigger_multiple", {
	...
	trigger_multiple_brush138.SetSolid(2)
	trigger_multiple_brush138.KeyValueFromString("mins", "-1 -1 -1")
	trigger_multiple_brush138.KeyValueFromString("maxs", "1 1 1")

	local trigger_bot_tag_brush139 = SpawnEntityFromTable("trigger_bot_tag", {
	    targetname = "tank_spawnroulette",
	    spawnflags = 1,
	    filtername = "filter_tank",
	    tags = "swooce",
	...
	trigger_bot_tag_brush139.SetSolid(2)
	trigger_bot_tag_brush139.KeyValueFromString("mins", "-1 -1 -1")
	trigger_bot_tag_brush139.KeyValueFromString("maxs", "1 1 1")

	local filter_tf_bot_has_tag318 = SpawnEntityFromTable("filter_tf_bot_has_tag", {
	    targetname = "filter_tank",
	    require_all_tags = 1,
	    tags = "swooce",
	    Negated = "Allow entities that match criteria"
	})
	filter_tf_bot_has_tag318.SetOrigin(org)
	filter_tf_bot_has_tag318.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport319 = SpawnEntityFromTable("point_teleport", {
	    targetname = "tank_spawn_01",
	    target = "!activator",
	    origin = Vector("-2048, -2432, 24")
	})
	point_teleport319.SetOrigin(org)
	point_teleport319.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system320 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_01_eff1",
	    effect_name = "utaunt_electricity_cloud_parent_WB",
	    origin = Vector("-2048, -2432, 24")
	})
	info_particle_system320.SetOrigin(org)
	info_particle_system320.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system321 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_01_eff2",
	    effect_name = "utaunt_lightning_bolt",
	    origin = Vector("-2048, -2432, 24")
	})
	info_particle_system321.SetOrigin(org)
	info_particle_system321.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport322 = SpawnEntityFromTable("point_teleport", {
	    targetname = "tank_spawn_02",
	    target = "!activator",
	    origin = Vector("-352, -3064, 8")
	})
	point_teleport322.SetOrigin(org)
	point_teleport322.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system323 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_02_eff1",
	    effect_name = "utaunt_electricity_cloud_parent_WB",
	    origin = Vector("-352, -3064, 8")
	})
	info_particle_system323.SetOrigin(org)
	info_particle_system323.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system324 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_02_eff2",
	    effect_name = "utaunt_lightning_bolt",
	    origin = Vector("-352, -3064, 8")
	})
	info_particle_system324.SetOrigin(org)
	info_particle_system324.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport325 = SpawnEntityFromTable("point_teleport", {
	    targetname = "tank_spawn_03",
	    target = "!activator",
	    origin = Vector("1376, -945, 24")
	})
	point_teleport325.SetOrigin(org)
	point_teleport325.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system326 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_03_eff1",
	    effect_name = "utaunt_electricity_cloud_parent_WB",
	    origin = Vector("1376, -945, 24")
	})
	info_particle_system326.SetOrigin(org)
	info_particle_system326.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system327 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_03_eff2",
	    effect_name = "utaunt_lightning_bolt",
	    origin = Vector("1376, -945, 24")
	})
	info_particle_system327.SetOrigin(org)
	info_particle_system327.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport328 = SpawnEntityFromTable("point_teleport", {
	    targetname = "tank_spawn_04",
	    target = "!activator",
	    origin = Vector("1376, 1120, 16")
	})
	point_teleport328.SetOrigin(org)
	point_teleport328.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system329 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_04_eff1",
	    effect_name = "utaunt_electricity_cloud_parent_WB",
	    origin = Vector("1376, 1120, 16")
	})
	info_particle_system329.SetOrigin(org)
	info_particle_system329.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system330 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_04_eff2",
	    effect_name = "utaunt_lightning_bolt",
	    origin = Vector("1376, 1120, 16")
	})
	info_particle_system330.SetOrigin(org)
	info_particle_system330.SetAngles(ang[0], ang[1], ang[2])

	local point_teleport331 = SpawnEntityFromTable("point_teleport", {
	    targetname = "tank_spawn_05",
	    target = "!activator",
	    origin = Vector("-8, 1556, 224")
	})
	point_teleport331.SetOrigin(org)
	point_teleport331.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system332 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_05_eff1",
	    effect_name = "utaunt_electricity_cloud_parent_WB",
	    origin = Vector("-8, 1556, 224")
	})
	info_particle_system332.SetOrigin(org)
	info_particle_system332.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system333 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "tank_spawn_05_eff2",
	    effect_name = "utaunt_lightning_bolt",
	    origin = Vector("-8, 1556, 224")
	})
	info_particle_system333.SetOrigin(org)
	info_particle_system333.SetAngles(ang[0], ang[1], ang[2])
	...
	local logic_case343 = SpawnEntityFromTable("logic_case", {
	...
	logic_case343.SetOrigin(org)
	logic_case343.SetAngles(ang[0], ang[1], ang[2])

}
::Camera_Crew_Death <- function(org, ang)
{
	local point_viewcontrol344 = SpawnEntityFromTable("point_viewcontrol", {
	...
	point_viewcontrol344.SetOrigin(org)
	point_viewcontrol344.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush140 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 64,
	    maxspeed = 1,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush140.SetSolid(2)
	func_rotating_brush140.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush140.KeyValueFromString("maxs", "1 1 1")

	local game_text345 = SpawnEntityFromTable("game_text", {
	...
	game_text345.SetOrigin(org)
	game_text345.SetAngles(ang[0], ang[1], ang[2])

	local logic_case346 = SpawnEntityFromTable("logic_case", {
	    targetname = "gameoverformat",
	    case16 = "You survived % waves",
	    "ondefault#1": "gameovertext,RunScriptCode,message ,0,-1",
	    "ondefault#2": "gameovertext,display,0,0,-1"
	})
	logic_case346.SetOrigin(org)
	logic_case346.SetAngles(ang[0], ang[1], ang[2])

	local point_viewcontrol347 = SpawnEntityFromTable("point_viewcontrol", {
	...
	point_viewcontrol347.SetOrigin(org)
	point_viewcontrol347.SetAngles(ang[0], ang[1], ang[2])

	local func_rotating_brush141 = SpawnEntityFromTable("func_rotating", {
	    spawnflags = 66,
	    maxspeed = 1,
	    solidbsp = 0,
	    rendermode = 10,
	...
	func_rotating_brush141.SetSolid(2)
	func_rotating_brush141.KeyValueFromString("mins", "-1 -1 -1")
	func_rotating_brush141.KeyValueFromString("maxs", "1 1 1")

	local env_fade348 = SpawnEntityFromTable("env_fade", {
	    targetname = "fade_out",
	    duration = 2,
	    holdtime = 0.5,
	    rendercolor = "0 0 0"
	})
	env_fade348.SetOrigin(org)
	env_fade348.SetAngles(ang[0], ang[1], ang[2])

	local env_fade349 = SpawnEntityFromTable("env_fade", {
	    targetname = "fade_in",
	    duration = 2,
	    holdtime = 0.5,
	    spawnflags = 1,
	...
	env_fade349.SetOrigin(org)
	env_fade349.SetAngles(ang[0], ang[1], ang[2])

	local point_populator_interface350 = SpawnEntityFromTable("point_populator_interface", {
	    targetname = "populator"
	})
	point_populator_interface350.SetOrigin(org)
	point_populator_interface350.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay351 = SpawnEntityFromTable("logic_relay", {
	    targetname = "gameover",
	    startdisabled = 1,
	    ...
	    "OnTrigger#9": "tf_gamerulesRunScriptCodeClientPrint(null, 4, `Game over`)3-1",
	...
	logic_relay351.SetOrigin(org)
	logic_relay351.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay352 = SpawnEntityFromTable("logic_relay", {
	    targetname = "youwin",
	    "OnTrigger#1": "finale_snd,volume,0,0,-1",
	    "OnTrigger#2": "tf_gamerulesRunScriptCodeClientPrint(null, 4, `Game over`)0-1",
	...
	logic_relay352.SetOrigin(org)
	logic_relay352.SetAngles(ang[0], ang[1], ang[2])

}
::FrearmPT <- function(org, ang)
{
	local logic_relay353 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "!activatorRunScriptCodeGiveWeapon(self,`INVALID`,-1,null)0.0-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION17"
	})
	logic_relay353.SetOrigin(org)
	logic_relay353.SetAngles(ang[0], ang[1], ang[2])

}
::ThundergunPT <- function(org, ang)
{
	local logic_relay354 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun_effect,Start,,0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION18"
	})
	logic_relay354.SetOrigin(org)
	logic_relay354.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay355 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun_hurt,RunScriptCode,self.SetOwner(!activator),0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION19"
	})
	logic_relay355.SetOrigin(org)
	logic_relay355.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay356 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun*,Kill,,0.35,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION20"
	})
	logic_relay356.SetOrigin(org)
	logic_relay356.SetAngles(ang[0], ang[1], ang[2])
	...
	local info_particle_system358 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "thundergun_effect",
	    effect_name = "utaunt_lightning_bolt",
	    angles = QAngle("0, 65, 90")
	})
	info_particle_system358.SetOrigin(org)
	info_particle_system358.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system359 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "thundergun_effect",
	    effect_name = "utaunt_lightning_bolt",
	    angles = QAngle("0, 115, 90")
	})
	info_particle_system359.SetOrigin(org)
	info_particle_system359.SetAngles(ang[0], ang[1], ang[2])

	local trigger_hurt_brush142 = SpawnEntityFromTable("trigger_hurt", {
	    damage = 5000,
	    damagetype = 4194304,
	...
	trigger_hurt_brush142.SetSolid(2)
	trigger_hurt_brush142.KeyValueFromString("mins", "-128 -48 -24")
	trigger_hurt_brush142.KeyValueFromString("maxs", "128 48 24")

}
::Thundergun_2PT <- function(org, ang)
{
	local logic_relay360 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun_effect,Start,,0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION21"
	})
	logic_relay360.SetOrigin(org)
	logic_relay360.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay361 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun_hurt,RunScriptCode,self.SetOwner(!activator),0.0,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION22"
	})
	logic_relay361.SetOrigin(org)
	logic_relay361.SetAngles(ang[0], ang[1], ang[2])

	local logic_relay362 = SpawnEntityFromTable("logic_relay", {
	    "OnTrigger#1": "thundergun*,Kill,,0.35,-1",
	    spawnflags = 1,
	    targetname = "OnSpawnOutput_CONVERSION23"
	})
	logic_relay362.SetOrigin(org)
	logic_relay362.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system363 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "thundergun_effect",
	    effect_name = "utaunt_lightning_bolt",
	    angles = QAngle("0, 90, 90")
	})
	info_particle_system363.SetOrigin(org)
	info_particle_system363.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system364 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "thundergun_effect",
	    effect_name = "utaunt_lightning_bolt",
	    angles = QAngle("0, 65, 90")
	})
	info_particle_system364.SetOrigin(org)
	info_particle_system364.SetAngles(ang[0], ang[1], ang[2])

	local info_particle_system365 = SpawnEntityFromTable("info_particle_system", {
	    targetname = "thundergun_effect",
	    effect_name = "utaunt_lightning_bolt",
	    angles = QAngle("0, 115, 90")
	})
	info_particle_system365.SetOrigin(org)
	info_particle_system365.SetAngles(ang[0], ang[1], ang[2])

	local trigger_hurt_brush143 = SpawnEntityFromTable("trigger_hurt", {
	    damage = 9750,
	    damagetype = 4194304,
	    targetname = "thundergun_hurt",
	    spawnflags = 1,
	...
	trigger_hurt_brush143.SetSolid(2)
	trigger_hurt_brush143.KeyValueFromString("mins", "-128 -48 -24")
	trigger_hurt_brush143.KeyValueFromString("maxs", "128 96 24")

}
::MedicbagPT <- function(org, ang)
{
	local trigger_hurt_brush144 = SpawnEntityFromTable("trigger_hurt", {
	    spawnflags = 1,
	...
	trigger_hurt_brush144.SetSolid(2)
	trigger_hurt_brush144.KeyValueFromString("mins", "-128 -128 -36")
	trigger_hurt_brush144.KeyValueFromString("maxs", "128 128 36")

	local mapobj_cart_dispenser366 = SpawnEntityFromTable("mapobj_cart_dispenser", {
	    spawnflags = 12,
	...
	mapobj_cart_dispenser366.SetOrigin(org)
	mapobj_cart_dispenser366.SetAngles(ang[0], ang[1], ang[2])

	local trigger_multiple_brush145 = SpawnEntityFromTable("trigger_multiple", {
	    spawnflags = 1,
	    filtername = "filter_notred",
	    origin = Vector("0, 0, 0"),
	    mins = "-128 -128 -36",
	...
	trigger_multiple_brush145.SetSolid(2)
	trigger_multiple_brush145.KeyValueFromString("mins", "-128 -128 -36")
	trigger_multiple_brush145.KeyValueFromString("maxs", "128 128 36")
}

Spawn_things(Vector("320, -32, 32"), ["0, 270, 0"])
Plate_Big(Vector("-540, -0, -182"), [0, 0, 0])
